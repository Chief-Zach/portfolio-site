          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="portfolio/src/components/NavBar#"><img src={navIcon1} alt="" /></a>
                <a href="portfolio/src/components/NavBar#"><img src={navIcon2} alt="" /></a>
                <a href="portfolio/src/components/NavBar#"><img src={navIcon3} alt="" /></a>
              </div>
              <HashLink to='#connect'>
